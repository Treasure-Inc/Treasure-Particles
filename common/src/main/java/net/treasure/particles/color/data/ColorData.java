...
import net.treasure.particles.color.data.duo.DuoColorData;
import net.treasure.particles.color.data.duo.DuoColorsData;
import net.treasure.particles.color.data.dynamic.DynamicColorData;
...
import net.treasure.particles.util.math.IntRange;
...
public class ColorData {
    ...
    public static ColorData fromString(String input) throws ReaderException {
        ...
        if (note) {
            ...
            var colorScheme = TreasureParticles.getColorManager().getColorScheme(colorName);
            if (colorScheme == null) throw new ReaderException("Unexpected color scheme name value: " + colorName);
            if (duoName != null) {
                var duoScheme = TreasureParticles.getColorManager().getColorScheme(duoName);
                if (duoScheme == null) {
                    try {
