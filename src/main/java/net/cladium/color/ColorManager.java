...
public class ColorManager {
    ...
    public boolean load() {
        try {
            File file = new File(CladiumPlugin.getInstance().getDataFolder(), "colors.yml");
            ...
            CladiumPlugin.getInstance().getLogger().log(Level.WARNING, "Couldn't load/create colors.yml", e);
            return false;
        }
    }
