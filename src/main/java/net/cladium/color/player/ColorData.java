package net.cladium.color.player;

import lombok.Getter;
import lombok.Setter;
import net.cladium.color.Color;
...
public class ColorData {
    ...
    public static ColorData initialize(String input) {
        ...
        return new ColorData(CladiumPlugin.getInstance().getColorManager().get(colorName), colorSpeed, revertWhenDone);
    }
}