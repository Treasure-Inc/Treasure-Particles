...
public class Effect {
    ...
    private static final Pattern PARTICLE = Pattern.compile("(?:particle \\[|(?<=\\,))(?<type>\\w+)(?:=)(?<value>[a-zA-Z0-9{}=*.;_  -]+)(?:(?=\\,)|\\])");
            ...
            if (line.startsWith("variable ")) {
                ...
                if (evalMatcher.matches()) {
                    ...
                    if (pair != null) {
                        ...
                        data.getLines().add(builder.build());
                    }
                }
                ...
                while (particleMatcher.find()) {
                    ...
                    if (key.equalsIgnoreCase("effect")) {
                        ...
                        builder.x(_value.replaceAll("\\{", "").replaceAll("}", ""));
                    else if (key.equalsIgnoreCase("y"))
                        builder.y(_value.replaceAll("\\{", "").replaceAll("}", ""));
                    else if (key.equalsIgnoreCase("z"))
                        builder.z(_value.replaceAll("\\{", "").replaceAll("}", ""));
            ...
            if (line.startsWith("variable ")) {
                ...
                if (evalMatcher.matches()) {
                    ...
                    if (pair != null) {
                        ...
                        data.getPostLines().add(builder.build());
                    }
                }
            } else if (line.startsWith("particle")) {
