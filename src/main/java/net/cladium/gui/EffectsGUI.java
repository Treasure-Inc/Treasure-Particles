...
import net.cladium.util.CustomItem;
...
public class EffectsGUI {
    ...
    public void open(Player player, int page) {
        EffectManager effectManager = CladiumPlugin.getInstance().getEffectManager();
        ...
        for (int i = page * 28; i < (page + 1) * 28; i++) {
            ...
            if (effect.getArmorColor() != null) {
                ...
                net.cladium.color.Color _color = CladiumPlugin.getInstance().getColorManager().get(effect.getArmorColor());
                if (_color != null) {
                    ColorData _data = new ColorData(_color, 1f, true);
                    updateSlots.put(where, _data);
                    color = _data.nextBukkit();
                } else
                    color = Color.fromRGB(java.awt.Color.decode(effect.getArmorColor()).getRGB());
            }
