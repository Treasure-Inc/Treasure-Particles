...
import net.treasure.particles.version.v1_16_R3.data.NMSGenericData;
import net.treasure.particles.version.v1_16_R3.data.color.NMSDustData;
import net.treasure.particles.version.v1_16_R3.data.color.NMSDustTransitionData;
