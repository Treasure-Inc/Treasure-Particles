package net.treasure.particles.version.v1_17_R1;
...
import net.treasure.particles.version.v1_17_R1.data.NMSGenericData;
import net.treasure.particles.version.v1_17_R1.data.color.NMSDustData;
import net.treasure.particles.version.v1_17_R1.data.color.NMSDustTransitionData;
...
public class NMSHandler extends AbstractNMSHandler {
    ...
    public void sendParticle(ParticleBuilder builder) {
        ...
        for (var player : Bukkit.getOnlinePlayers()) {
            ...
            ((CraftPlayer) player).getHandle().b.a.sendPacket(packet);
        }
    }
