package net.treasure.particles.version.v1_18_R2;

import net.minecraft.network.protocol.Packet;
import net.minecraft.network.protocol.game.PacketListenerPlayOut;
import net.minecraft.network.protocol.game.PacketPlayOutWorldParticles;
import net.treasure.particles.version.v1_18_R2.data.color.NMSDustTransitionData;
...
import net.treasure.particles.version.v1_18_R2.data.color.NMSDustData;
import net.treasure.particles.version.v1_18_R2.data.NMSGenericData;
