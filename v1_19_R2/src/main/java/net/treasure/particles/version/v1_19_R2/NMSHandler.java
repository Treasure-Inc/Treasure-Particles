...
import net.treasure.particles.version.v1_19_R2.data.NMSGenericData;
import net.treasure.particles.version.v1_19_R2.data.color.NMSDustData;
import net.treasure.particles.version.v1_19_R2.data.color.NMSDustTransitionData;
...
public class NMSHandler extends AbstractNMSHandler {
    ...
    public void strikeLightning(Location location, Predicate<Player> filter) {
        ...
        var lightning = new EntityLightning(EntityTypes.Y, ((CraftWorld) location.getWorld()).getHandle());
