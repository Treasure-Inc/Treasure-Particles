package net.treasure.particles.version.v1_21_R3;
...
import net.treasure.particles.version.v1_21_R3.data.NMSGenericData;
import net.treasure.particles.version.v1_21_R3.data.color.NMSDustData;
import net.treasure.particles.version.v1_21_R3.data.color.NMSDustTransitionData;
...
public class NMSHandler extends AbstractNMSHandler {
    ...
    public void strikeLightning(Location location, Predicate<Player> filter) {
        ...
        var lightning = new EntityLightning(EntityTypes.aw, ((CraftWorld) location.getWorld()).getHandle());
